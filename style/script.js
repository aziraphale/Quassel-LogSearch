     ...
     function such()     {
             ...
             new Ajax.Updater('scontent', 'suche.php?search=1&string=' + document.getElementById('input').value + '&buffername=' + document.getElementById('buffer').value + '&number=' + document.getElementById('number').value, {asynchronous:true, evalScripts:true});    }

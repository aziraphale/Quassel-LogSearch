...
?>
<div style="margin:-18px;float:right;height:70px; width:50px; right:0px;top:0px;position:relative;z-index:10;background-color:white;"><span style="float:right;margin: 3px;" onclick="javascript:document.getElementById('scontent').innerHTML = '<center><?=_('Waiting for search ...')?></center>';">[ x ]</span></div><center>
